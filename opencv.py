...
model = tf.keras.models.load_model('final/VGG.h5')
...
while cap.isOpened():
    ...
    #print("confidence score: ", sconfidence_score)
    ...
    fps = 1/totalTime
    # print("FPS:", fps)
    cv2.putText(img, "Label : " + class_name, (75,50), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255,255,0), 2)
    cv2.putText(img, str(float("{:.2f}".format(confidence_score*100))) + "%", (75,100),cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255,255,0), 2)
